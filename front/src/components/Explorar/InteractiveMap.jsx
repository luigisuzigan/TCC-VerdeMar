...
export default function InteractiveMap({ 
  ...
  const handleOverlayComplete = useCallback((overlay) => {
    ...
    if (onBoundaryChange) {
      onBoundaryChange(overlay.overlay);
    }
  }, [onBoundaryChange]);
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  <div className="w-16 h-16 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-2xl">
                    🗺️
                  </div>
                ...
                >
                  <div className="w-16 h-16 rounded-lg bg-green-100 border border-slate-200 flex items-center justify-center text-2xl">
                    🏞️
                  </div>
                ...
                >
                  <div className="w-16 h-16 rounded-lg bg-slate-700 border border-slate-200 flex items-center justify-center text-2xl">
                    🛰️
                  </div>
